...
if("TRUE" STREQUAL "TRUE")
  set(gscam_SOURCE_PREFIX /home/aguias/pi-tank/src/gscam)
  set(gscam_DEVEL_PREFIX /home/aguias/pi-tank/devel)
  set(gscam_INSTALL_PREFIX "")
  set(gscam_PREFIX ${gscam_DEVEL_PREFIX})
else()
  set(gscam_SOURCE_PREFIX "")
  set(gscam_DEVEL_PREFIX "")
  set(gscam_INSTALL_PREFIX /home/aguias/pi-tank/install)
...
if(NOT "/home/aguias/pi-tank/src/gscam/include;/usr/include/gstreamer-1.0;/usr/lib/x86_64-linux-gnu/gstreamer-1.0/include;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include " STREQUAL " ")
  set(gscam_INCLUDE_DIRS "")
  set(_include_dirs "/home/aguias/pi-tank/src/gscam/include;/usr/include/gstreamer-1.0;/usr/lib/x86_64-linux-gnu/gstreamer-1.0/include;/usr/include/glib-2.0;/usr/lib/x86_64-linux-gnu/glib-2.0/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gscam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aguias/pi-tank/src/gscam/${idir}'.  ${_report}")
    endif()
    _list_append_unique(gscam_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "gscam;gstapp-1.0;gstbase-1.0;gstreamer-1.0;gobject-2.0;glib-2.0")
