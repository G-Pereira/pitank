...
if(NOT "/home/aguias/pi-tank/devel/include;/home/aguias/pi-tank/src/image_pipeline/image_proc/include;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  set(image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/aguias/pi-tank/devel/include;/home/aguias/pi-tank/src/image_pipeline/image_proc/include;/usr/local/include;/usr/local/include/opencv")
  if(NOT " " STREQUAL " ")
...
set(libraries "image_proc;/usr/local/lib/libopencv_calib3d.so.3.2.0;/usr/local/lib/libopencv_core.so.3.2.0;/usr/local/lib/libopencv_features2d.so.3.2.0;/usr/local/lib/libopencv_flann.so.3.2.0;/usr/local/lib/libopencv_highgui.so.3.2.0;/usr/local/lib/libopencv_imgcodecs.so.3.2.0;/usr/local/lib/libopencv_imgproc.so.3.2.0;/usr/local/lib/libopencv_ml.so.3.2.0;/usr/local/lib/libopencv_objdetect.so.3.2.0;/usr/local/lib/libopencv_photo.so.3.2.0;/usr/local/lib/libopencv_shape.so.3.2.0;/usr/local/lib/libopencv_stitching.so.3.2.0;/usr/local/lib/libopencv_superres.so.3.2.0;/usr/local/lib/libopencv_video.so.3.2.0;/usr/local/lib/libopencv_videoio.so.3.2.0;/usr/local/lib/libopencv_videostab.so.3.2.0;/usr/local/lib/libopencv_viz.so.3.2.0")
